...
## <div style="text-align: center">QuizWhiz JSON Toolkit <span style="font-size: 0.7em; font-style: italic">*v4.6.5*</span></div>
...
2. For executable version: Download the appropriate executable for your operating system:
   - **Windows**: `QuizWhiz-Toolkit_v4.6.5_Windows.exe`
- **macOS**: `QuizWhiz-Toolkit_v4.6.5_macOS`
- **Linux**: `QuizWhiz-Toolkit_v4.6.5_Linux`
...
./QuizWhiz-Toolkit_v4.6.5_Windows.exe  # Windows
./QuizWhiz-Toolkit_v4.6.5_macOS        # macOS
./QuizWhiz-Toolkit_v4.6.5_Linux        # Linux
...
pyinstaller --onefile --windowed --name "QuizWhiz-Toolkit_v4.6.5" --clean quiz_toolkit.py
...
[version-shield]: https://img.shields.io/badge/version-4.6.5-blue.svg
