...
## <div style="text-align: center">QuizWhiz JSON Toolkit <span style="font-size: 0.7em; font-style: italic">*v4.4.2*</span></div>
...
2. For executable version: Download the appropriate executable for your operating system:
   - **Windows**: `QuizWhiz-Toolkit_v4.4.2_Windows.exe`
- **macOS**: `QuizWhiz-Toolkit_v4.4.2_macOS`
- **Linux**: `QuizWhiz-Toolkit_v4.4.2_Linux`
...
./QuizWhiz-Toolkit_v4.4.2_Windows.exe  # Windows
./QuizWhiz-Toolkit_v4.4.2_macOS        # macOS
./QuizWhiz-Toolkit_v4.4.2_Linux        # Linux
...
pyinstaller --onefile --windowed --name "QuizWhiz-Toolkit_v4.4.2" --clean quiz_toolkit.py
...
[version-shield]: https://img.shields.io/badge/version-4.4.2-blue.svg
