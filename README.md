...
## <div style="text-align: center">QuizWhiz JSON Toolkit <span style="font-size: 0.7em; font-style: italic">*v4.4.4*</span></div>
...
2. For executable version: Download the appropriate executable for your operating system:
   - **Windows**: `QuizWhiz-Toolkit_v4.4.4_Windows.exe`
- **macOS**: `QuizWhiz-Toolkit_v4.4.4_macOS`
- **Linux**: `QuizWhiz-Toolkit_v4.4.4_Linux`
...
./QuizWhiz-Toolkit_v4.4.4_Windows.exe  # Windows
./QuizWhiz-Toolkit_v4.4.4_macOS        # macOS
./QuizWhiz-Toolkit_v4.4.4_Linux        # Linux
...
pyinstaller --onefile --windowed --name "QuizWhiz-Toolkit_v4.4.4" --clean quiz_toolkit.py
...
[version-shield]: https://img.shields.io/badge/version-4.4.4-blue.svg
